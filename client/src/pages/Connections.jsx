  ...
  return (
    <div className="min-h-screen bg-slate-50">
      <div className="max-w-6xl mx-auto p-6">
        ...
        {/* Tabs */}
        <div className="inline-flex items-center gap-4 mb-6 bg-white rounded-md p-4 shadow-sm border border-gray-200">
          {dataArray.map((tab) => (
            <button
              key={tab.label}
                  ...
                  <div className="flex max-sm:flex-col gap-2 mt-4">
                    ...
                    {currentTab === "Connections" && (
                      <button
                        ...
                        className=" flex items-center gap-2 w-full p-2 text-sm rounded bg-slate-100 hover:bg-slate-200 text-black active:scale-95 transition cursor-pointer"
                      >
