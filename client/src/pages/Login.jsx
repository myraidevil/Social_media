...
const Login = () => {
  return (
    <div className='min-h-screen flex flex-col md:flex-row'>
        {/* background Image */}
        <img src={assets.bgImage} alt="background imagee" className='absolute top-0 left-0 -z-1 w-full h-full object-cover' />
        ...
        <div className='flex-1 flex flex-col items-start justify-between p-6 md:p-10 lg:pl-40 '>
            <img src={assets.logo} alt="logo" className='h-12 object-contain' />
                <div>
                  ...
                  <p className='tet-xl md;text-3xl text-indigo-900 max-w-72 md:max-w-md'>connect with global community on here</p>
                </div>
