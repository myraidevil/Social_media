...
const UserCard = ({ user }) => {
  ...
  return (
    <div className="p-4 pt-6 flex flex-col justify-between items-center w-72 shadow border border-gray-200 rounded-md ">
      <div className="text-center">
        ...
        {user.bio && (
          <p className="text-gray-500 mt-2 text-center font-light">
            {user.bio}
          </p>
        )}
      </div>
